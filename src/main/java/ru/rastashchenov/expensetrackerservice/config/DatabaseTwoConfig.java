...
public class DatabaseTwoConfig {
    ...
    public static final String PROPERTY_PREFIX = "spring.dbtwo.datasource";
    public static final String JPA_REPOSITORY_PACKAGE = "ru.rastashchenov.expensetrackerservice.repository.dbtwo";
    public static final String ENTITY_PACKAGE = "ru.rastashchenov.expensetrackerservice.domain.entity.dbtwo";
